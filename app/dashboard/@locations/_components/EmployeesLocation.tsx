...
export default async function EmployeesLocation({ store }: { store: string | string[] | undefined }) {
    ...
    return data.map((employee: Employee) => {
        ...
        return (
            <Card key={employee.employeeId} className="mx-10 last:mb-5 mb-10 border-2 border-amber-100 text-zinc-600 hover:scale-110 hover:text-black hover:bg-amber-50 hover:border-orange-300">
                <CardHeader>
